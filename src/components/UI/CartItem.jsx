  ...
  return (
    <article className="mb-12 flex flex-col gap-y-4 sm:flex-row flex-wrap border-b border-base-300 pb-6 last:border-b-0">
      ...
      <div className="sm:ml-16">
        ...
        {/*COMPANY*/}
        <h4 className="mt-4 capitalize text-sm text-neutral-content">{company}</h4>
        {/*COLOR*/}
      ...
      <div className="sm:ml-24">
        ...
        {/*REMOVE*/}
        <button className="mt-5 link link-primary link-hover text-sm" onClick={removeItemFromCart}>Remove</button>
      </div>
      {/*PRICE*/}
